...
let X0 = 0; //X o semilla
let X1 = 0; //constante
let X2 = 0; //contenedor de resultado de multiplicar X0 x constante
...
function productos_medios()
{
    ...
    for(iteracionActual = 0; iteracionActual < cantidadIteraciones; iteracionActual++)
    {
        ...
        resultadoY = 'Y' + iteracionActual + ' = (' + X1 + ')  (' + X0 + ') = ';

        //multiplica X0 por X1(constante)
        ...
        //reasigna la variables X0 que es la unica que cambia; cambia pro el resultado
        //de los numeros centrales de la multiplicacion
        X0 = X2;
